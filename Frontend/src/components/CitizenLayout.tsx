...
import { LayoutDashboard, FileText, Search, Trophy, Gift, AlertTriangle, MessageSquare, LogOut, Menu, X } from 'lucide-react';
        ...
        <div className="sticky top-0 z-30 bg-card border-b border-border flex items-center justify-between px-4">
          <div className="flex items-center gap-3 lg:hidden py-3">
            ...
            <h2 className="text-sm font-heading font-semibold">
              {t('citizen.welcome', { name: currentUser?.name || '' })}
            </h2>
          </div>
          <LanguageSwitcher className="hidden lg:inline-flex" />
          <AppHeader title="JANVANI — Voice of the People" />
        </div>
